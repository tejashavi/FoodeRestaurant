 ...
 */
public class PreparingOrderFragment extends BaseFragment {
    ...
    void getPreparingOrder() {
       // AppUtils.showRequestDialog(mActivity);
        HashMap<String, String> hm = new HashMap<>();
         hm.put("shop_id", AppSettings.getString(AppSettings.shopId));
        // hm.put("shop_id", "3");
        hm.put("value", "3");
        Call<PendingOrderModel> pendingOrderModelCall = apiInterface.getPreparingOrder(hm);
